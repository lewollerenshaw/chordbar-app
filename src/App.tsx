  ...
  return (
    ...
    >
      <Box d="flex" flexDirection="column" alignItems="center">
        <Box fontSize="large">{chord.Degree}</Box>
  ...
  return (
    <div className="App">
      <div className="header">
        ...
        <Heading as="h2" size="1xl" color="gray">
          What'll it be?
        </Heading>
      </div>
      ...
      <form className="form">
        {showFormError && (
          <Alert status="error" className="error">
            ...
            <AlertDescription>
              Please check you have completed the form inputs.
            </AlertDescription>
          </Alert>
        )}
          ...
          <SimpleGrid columns={[1, 1, 3]} spacing={10}>
            <Box>
              <FormControl id="key">
                ...
                <FormHelperText>
                  Which key you want your progression
                </FormHelperText>
              </FormControl>
            </Box>
            <Box>
              <FormControl id="mode">
                ...
                <FormHelperText>
                  Which mode you want your progression
                </FormHelperText>
              </FormControl>
            </Box>
            <Box>
        ...
        <div className="form__actions">
          <Checkbox
            className="form__actions__root"
            defaultChecked
            onChange={(e: {
              target: { checked: React.SetStateAction<boolean> }
            }) => setResolveRoot(e.target.checked)}
          >
            Resolve on root
          </Checkbox>
          <Checkbox
            onChange={(e: {
              target: { checked: React.SetStateAction<boolean> }
            }) => setIsDiminished(e.target.checked)}
          >
            Diminished chord
          </Checkbox>
        </div>
        ...
        <div className="form__submit">
          <Button colorScheme="blue" onClick={() => generateProgression()}>
            Go
          </Button>
        </div>
      </form>
